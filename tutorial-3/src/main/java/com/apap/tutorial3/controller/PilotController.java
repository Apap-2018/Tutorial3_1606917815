...
public class PilotController {
	...
	public String changeFlyHour(@PathVariable String licenseNumber, @PathVariable String flyhour, Model model) {
		PilotModel archive = pilotService.getPilotDetailByLicenseNumber(licenseNumber);
		if (archive != null) {
			model.addAttribute("pilot", archive);
			archive.setFlyHour(Integer.parseInt(flyhour));
			return "view-pilot";
		}else {
	...
	public String deleteID(@PathVariable String idNumber, Model model) {
		PilotModel archive = pilotService.getPilotDetailById(idNumber);
		...
		if (archive != null) {
			...
			//archive = null;
//			archive.setId(null);
//			archive.setLicenseNumber(null);
//			archive.setName(null);
//			archive.setFlyHour(null);
